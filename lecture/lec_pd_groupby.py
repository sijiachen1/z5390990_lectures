...
# ----------------------------------------------------------------------------
#print(df)
groups = df.groupby(by='firm', group_keys=True)
#print(groups)
#print(type(groups))
...
#                                      firm  action
# firm           date
# Deutsche Bank  2020-09-23 08:58:55  False   False
#                2020-09-23 09:01:26  False   False
#                2020-09-23 11:15:12  False   False
# JP Morgan      2012-02-16 07:42:00  False   False
#                2020-12-09 15:34:34  False   False
# Morgan Stanley 2020-11-18 11:07:44  False   False
# Wunderlich     2020-09-23 09:11:01  False   False
...
#print(df.groupby('firm').count())
#print(type(df.groupby('firm').count()))
#print(df.groupby('firm').size())
#print(type(df.groupby('firm').size()))
